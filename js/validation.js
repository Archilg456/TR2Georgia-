...
forRegistration.addEventListener("submit", function (event) {
  ...
  minRequirement.addEventListener("keyup", function () {
    ...
    if (passValue == "") {
      ...
      passError.innerText =
        " Password must contain at least 8 characters, one uppercase character, one lowercase character and one number ";
      passError.style.color = "brown";
      minRequirement.style.border = "2px solid brown";
    } else {
      passError.innerText = "";
...
emailfield.addEventListener("keyup", function () {
  ...
  if (emailValue.match(emailPattern)) {
    ...
    spanErorr.style.color = "#161619";
    spanErorr.style.fontWeight = "800";
    emailfield.style.border = "2px solid #161619";
  } else {
